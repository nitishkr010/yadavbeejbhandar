...
const Organic = () => {
  ...
  useEffect(() => {
    fetch(
      "https://yadavbeejbhandarr.onrender.com/api/products?category=Organic"
    )
      .then((res) => res.json())
      .then((data) => {
        setOrganicProducts(data);
        setLoading(false);
      })
      .catch((err) => {
        console.log(err);
    ...
    <div className="pt-60 pb-16 bg-green-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-center text-gray-600 mb-12">
          Organic aur eco-friendly products se behtar aur surakshit kheti karein.
        </p>
 ...
 <p className="text-gray-700 mt-2">
                    ...
                    <div className="flex gap-2 mt-4">
                      ...
                      <button
                        ...
                        className="w-1/2 bg-green-700 text-white py-3 rounded-lg"
                      >
                        Add To Cart
                      </button>
